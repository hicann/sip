...
int main(int argc, char** argv)
{
    ...
    ret = aclrtMemcpy(tensorInXData.data(), tensorXSize * sizeof(std::complex<float>), inputXDeviceAddr,
                      tensorXSize * sizeof(std::complex<float>), ACL_MEMCPY_DEVICE_TO_HOST);
