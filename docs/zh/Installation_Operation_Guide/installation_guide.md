...
请参考 **[安装CANN](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910/softwareinst/instg/instg_0000.html?OS=openEuler&InstallType=netyum)**，根据如下步骤安装信号处理加速库：
