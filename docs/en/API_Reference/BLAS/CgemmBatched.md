...
<!-- md-trans-meta sourceCommit=a6b47bb7404ddae87dcea5848180621e53ca7580 translatedAt=2026-08-12T10:48:12.933Z pushedAt=2026-08-20T11:47:59.721Z -->
...
`asdBlasMakeCgemmBatchedPlan`: initializes the operator configuration corresponding to the handle.\
`asdBlasCgemmBatched`: used to compute the product of two batches of complex matrices.
...
After the `asdBlasCgemmBatched` operator is called, the output `C` is:\
[   [ -1+9i, -7+13i ],
    [ -7+17i, -21+21i ]  ]
...
- **Parameter description:**
  ...
  <tbody>
    ...
    <tr>
      <td>lda (int64_t)</td>
      <td>Input</td>
      <td>Memory address offset between adjacent elements in A. The value equals k.</td>
    </tr>
    <tr>
      <td>ldb (int64_t)</td>
      <td>Input</td>
      <td>Memory address offset between adjacent elements in B. The value equals n.</td>
    </tr>
    <tr>
      <td>ldc (int64_t)</td>
      <td>Input</td>
      <td>Memory address offset between adjacent elements of C in the left-right direction. The value is equal to n.</td>
    </tr>
    <tr>
      <td>A (aclTensor *)</td>
      <td>Input</td>
      <td><ul><li>Input matrix, corresponding to "A" in the formula.</li><li>Supported data type: <code>COMPLEX64</code>.</li><li>Data format: <code>ND</code>.</li><li>Shape: [batchCount, m, k].</li></ul></td>
    </tr>
    <tr>
      <td>B (aclTensor *)</td>
      <td>Input</td>
      <td><ul><li>Input matrix, corresponding to "B" in the formula.</li><li>Supported data type: <code>COMPLEX64</code>.</li><li>Data format: <code>ND</code>.</li><li>Shape: [batchCount, k, n].</li></ul></td>
    </tr>
    <tr>
      <td>C (aclTensor *)</td>
      <td>Output</td>
      <td><ul><li>Corresponding to "C" in the formula.</li><li>Supported data type: <code>COMPLEX64</code>.</li><li>Data format: <code>ND</code>.</li><li>Shape: [batchCount, m, n].</li></ul></td>
    </tr>
    <tr>
      <td>alpha (std::complex&lt;float&gt; &amp;)</td>
      <td>Input</td>
      <td>Corresponding to "alpha" in the formula. A complex scalar used to multiply the result of the matrix multiplication. The value must be 1+0j.</td>
    </tr>
    <tr>
      <td>beta (std::complex&lt;float&gt; &amp;)</td>
      <td>Input</td>
      <td>Corresponds to beta in the formula, a complex scalar used to multiply matrix C. The value must be 0+0j.</td>
    </tr>
    <tr>
