...
<!-- md-trans-meta sourceCommit=cec88e057607a630073cce4bbace3c21f8d93fe7 translatedAt=2026-08-12T10:53:33.152Z pushedAt=2026-08-20T11:47:59.771Z -->
...
- Formula:
 ...
 [   [ 1,2 ],
  ...
  After the `asdBlasSsyr2` operator is called, the output `A` is:\
 [   [ 15.07, 25.45 ],
    [ 26.45,  41.52 ]  ].
...
- **Parameter description:**
  ...
  <tbody>
    ...
    <tr>
      <td>alpha (float &)</td>
      <td>Input</td>
      <td>Alpha in the formula, a scalar scaling factor for the vector product.</td>
    </tr>
    <tr>
      <td>x (aclTensor *)</td>
      <td>Input</td>
    ...
    <tr>
      <td>lda (int64_t)</td>
      <td>Input</td>
      <td>Storage stride of elements in each column of matrix A (constrained to n in the current version).</td>
    </tr>
...
- The number of input elements `n` is currently in the range [1, 8192].

- The input shapes of the operator are [n], [n], and [n, n], and the output shape is [n, n].
