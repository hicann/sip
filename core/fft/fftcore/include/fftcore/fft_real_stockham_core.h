...
class FftRealStockhamCore : public FFTCoreBase {
public:
    FftRealStockhamCore(unsigned nDone, unsigned nDoing, unsigned nLeft, unsigned batch, AsdSip::asdFftType fftType,
                        bool forward);
    ~FftRealStockhamCore() override;
