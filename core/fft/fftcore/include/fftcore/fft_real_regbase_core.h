...
class FftRealRegBaseCore : public FFTCoreBase {
public:
    FftRealRegBaseCore(unsigned nDone, unsigned nDoing, unsigned nLeft, unsigned batch, AsdSip::asdFftType fftType,
                       bool forward);
    ~FftRealRegBaseCore() override;
